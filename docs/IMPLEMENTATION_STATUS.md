...
- Lower-page sections use full-width rows with headings beside their text on desktop, bounded text line lengths, and full-width FAQ rules. The editor exposes this as “Heading beside text”; smaller screens stack the content.
